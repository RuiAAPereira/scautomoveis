...
<head>
  ...
  <!-- Lightbox2 -->
  <link href="<?php echo base_url('lightbox2/css/lightbox.css'); ?>" rel="stylesheet" />
  <?php echo $this->renderSection('extra-css'); ?>
</head>
...
<body class="app header-fixed sidebar-fixed aside-menu-fixed sidebar-lg-show">
  ...
  <div class="app-body">
    ...
    <?php
    // echo $this->include('layouts/component/aside-menu');
    ?>

  </div>
  <footer class="app-footer">
    <div>
      <a href="#">Rui Pereira</a>
      <span>&copy; 2021.</span>
    </div>
    <div class="ml-auto">
  ...
  <script src="<?php //echo base_url('core-ui/vendors/chart.js/js/Chart.min.js'); 
                ?>"></script>
  <script src="<?php //echo base_url('core-ui/vendors/@coreui/coreui-plugin-chartjs-custom-tooltips/js/custom-tooltips.min.js'); 
                ?>"></script>
  <script src="<?php //echo base_url('core-ui/js/main.js'); 
                ?>"></script>
  <!-- Lightbox2 -->
  <script src="<?php echo base_url('lightbox2/js/lightbox.js'); ?>"></script>
  <script>
    $(function() {
